	...
	return (
		<Wrapper className='section-center'>
			...
			<article className='img-container'>
				<img src={heroBcg} alt='two people walking and laughing' className='main-img' />
				<img src={heroBcg2} alt='Jeans, scarf, clothing material and coffee' className='accent-img' />
			</article>
		</Wrapper>
	);
};
